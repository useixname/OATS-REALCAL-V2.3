#!/usr/bin/env python3
"""REAL-CAL analysis: produce E1-E8 tables (实验.md) + hypothesis verdicts.

Reads results/formal-realcal/raw/*.json and writes CSV/JSON artifacts to
reports/realcal-analysis/. Pure post-processing; no simulation.
"""
...
_parser.add_argument("--results", type=Path, default=ROOT / "results" / "formal-realcal")
_parser.add_argument("--out", type=Path, default=ROOT / "reports" / "realcal-analysis")
